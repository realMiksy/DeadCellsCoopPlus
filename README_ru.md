# DeadCellsCoopPlus — стабильный кооператив v0.8.36
...
Версия v0.8.36 направлена на стабильный кооператив для двух игроков, безопасные переходы между уровнями, улучшенную синхронизацию врагов, подключение через Steam, систему возрождения и обновлённый Party HUD.
...
Оба игрока должны использовать одинаковую версию мода. Для v0.8.36 в логе должна быть строка:

```text
[NetMod] Source build: v0.8.36-zdoor-sublevel-render-guard
```

## Проверенные переходы v0.8.36
