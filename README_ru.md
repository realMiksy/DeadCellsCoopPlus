# DeadCellsCoopPlus — стабильный кооператив v0.8.37
...
Версия v0.8.37 сохраняет все исправления стабильности v0.8.36 и выделяет пункт **Play Multiplayer** в главном меню мягким голубым цветом.
...
Оба игрока должны использовать одинаковую версию мода. Для v0.8.37 в логе должна быть строка:

```text
[NetMod] Source build: v0.8.37-blue-multiplayer-menu
```

## Проверенные переходы v0.8.37
